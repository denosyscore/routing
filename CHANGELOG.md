...
## [0.5.0-alpha.4] – 2025-12-23

### Changed

-   **TypeBasedResolver**: Now supports parameters type-hinted with classes/interfaces that implement `ServerRequestInterface` or `ResponseInterface`, not just the exact interface types

## [0.5.0-alpha.3] – 2025-12-18
